    ...
    def _read__objects(self):
        ...
        for object_class in object_classes:
            ...
            for name in object_classes[object_class]:
                ...
                img = Image.open("./core/environments/configs/gridworld/grid_objects/%s.png" % name)
        ...
        agent_image = Image.open("./core/environments/configs/gridworld/grid_objects/agent.png")
