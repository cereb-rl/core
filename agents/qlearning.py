...
from core.utils.Policy import TabularPolicy, DiscreteTabularPolicy
...
QLEARNING_DEFAULTS: Dict[str, float] = {
    ...
    'default_q_value': 20  # Initial Q value
}
...
class QLearningAgent(BaseAgent):
    ...
    def __init__(self, observation_space, action_space, name="Q-Learning Agent", extra_params={}, starting_policy=None):
